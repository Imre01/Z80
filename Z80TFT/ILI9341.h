...
//#define TFT_RD_pin      LATCbits.LATC13     ////TFT_RD_pin = 1; 
//#define TFT_CS_pin      LATDbits.LATD2       //   


//#define TFT_RST_pin     PORTB5      //
//#define TFT_RS_pin      PORTB6    //
//#define TFT_WR_pin     PORTB7     //
 
void Delay_ms(int dat){
    unsigned int i;
    for(i=0; i<dat; i++){}
}
...
void TFT_reset(void)
{
    PORTB5(1) ;   // TFT_RST_pin     PORTB5      //
    Delay_ms(500);
     PORTB5(0);    // TFT_RST_pin     PORTB5      //
    Delay_ms(500);
     PORTB5(1);    // TFT_RST_pin     PORTB5      //
    Delay_ms(500);
}
...
void Write_Command(unsigned int command)
{
    PORTB6(0);              //#define TFT_RS_pin      PORTB6    //
    PORTC(command);
    PORTB7(0);             //#define TFT_WR_pin     PORTB7     //  // WRITE ON RISE
    PORTB7(1);             //#define TFT_WR_pin     PORTB7     //                 
}


void Write_Data(unsigned int data )
{
    PORTB6(1);              //#define TFT_RS_pin      PORTB6    //
    PORTC(data);
    PORTB7(0);              //#define TFT_WR_pin     PORTB7     // // WRITE ON RISE
    PORTB7(1);             //#define TFT_WR_pin     PORTB7     //
}
...
void Write_Data2(unsigned int data )
{
    ...
    datax= ((data>>8)& 0x00ff);                       
    PORTC(datax);
    PORTB7(0);              //#define TFT_WR_pin     PORTB7     //
    PORTB7(1);             //#define TFT_WR_pin     PORTB7     //
